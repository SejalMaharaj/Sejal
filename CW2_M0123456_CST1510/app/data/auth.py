...
def register_user(username, password):
    ...
    with open("../../CW2_M0123456_CST1510/DATA/users.txt", "a") as f:
...
def login_user(username, password):
    if not os.path.exists("../../CW2_M0123456_CST1510/DATA/users.txt"):
        print("No users registered yet.")
        return False

    with open("../../CW2_M0123456_CST1510/DATA/users.txt", "r") as f:
        for line in f:
